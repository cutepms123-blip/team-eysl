const VERSION='team-eysl-final93-owner-time';
const CACHE=`team-eysl-${VERSION}`;
const PRECACHE=['/manifest.webmanifest','/icon-192.png','/icon-512.png','/apple-touch-icon.png','/enhancements-v93.js'];
...
async function navigationResponse(req){
  try{
    ...
    if(!html.includes('/enhancements-v93.js'))html=html.replace('</body>','<script src="/enhancements-v93.js?v=final93-owner-time"></script></body>');
